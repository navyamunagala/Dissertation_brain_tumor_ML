...
unique_sets = dataset.drop_duplicates(
    subset=["Patient ID", "AffectedArea", "severity", "Age", "Treatment", "Size", "Class"])
print(unique_sets)
...
data = unique_sets[["Patient ID", "AffectedArea", "severity", "Age", "Treatment", "Size", "Class"]].replace("empty",
                                                                                                            np.nan)
print(data.head(10))
...
print(data['Patient ID'].fillna(data['Patient ID'].median(), inplace=True),
      ...
      data['Treatment'].fillna(data['Treatment'].median(), inplace=True),
      data['severity'].fillna(data['severity'].median(), inplace=True),
      data['AffectedArea'].fillna(data['AffectedArea'].median(), inplace=True)
      )
...
allColumns = ['Patient ID', 'AffectedArea', 'severity', 'Age', 'Treatment', 'Size', 'Size_uniform_discrete',
